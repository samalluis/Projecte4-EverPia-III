...
Crea una carpeta de prova a Documents. Genera arxius grans per simular dades reals. Obre el CMD (Símbol del sistema) com a administrador i usa fsutil (segons els recursos):
...
- Source Data: Selecciona la carpeta de l'usuari (especialment Documents).
- Schedule (Horari): Marca "Automatically run backups".
...
- Destination: Storage Type: Google Drive.
...
- Afegeix un disc de 10GB a la MV Ubuntu. Identifica el disc (sol ser /dev/sdb):
